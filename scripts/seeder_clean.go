	...
	resources := []*models.Resource{
		{
			...
			Midia:   null.StringFrom("https://picsum.photos/400/300?random=1"),
			Image:   null.StringFrom("https://picsum.photos/400/300?random=1"),
			Average: null.Float64From(4.5),
		},
		{
			Name:    null.StringFrom("Monitor LG UltraWide 29\""),
			Type:    null.StringFrom("hardware"),
			Midia:   null.StringFrom("https://picsum.photos/400/300?random=2"),
			Image:   null.StringFrom("https://picsum.photos/400/300?random=2"),
			Average: null.Float64From(4.8),
		},
		{
			Name:    null.StringFrom("Licença Adobe Creative Cloud"),
			Type:    null.StringFrom("software"),
			Midia:   null.StringFrom("https://picsum.photos/400/300?random=3"),
			Image:   null.StringFrom("https://picsum.photos/400/300?random=3"),
			Average: null.Float64From(4.7),
		},
		{
			Name:    null.StringFrom("Sala de Reunião A"),
			Type:    null.StringFrom("espaço"),
			Midia:   null.StringFrom("https://picsum.photos/400/300?random=4"),
			Image:   null.StringFrom("https://picsum.photos/400/300?random=4"),
			Average: null.Float64From(4.2),
		},
		{
			Name:    null.StringFrom("Workstation Mac Studio"),
			Type:    null.StringFrom("hardware"),
			Midia:   null.StringFrom("https://picsum.photos/400/300?random=5"),
			Image:   null.StringFrom("https://picsum.photos/400/300?random=5"),
			Average: null.Float64From(4.9),
		},
		{
			Name:    null.StringFrom("Licença JetBrains IntelliJ"),
			Type:    null.StringFrom("software"),
			Midia:   null.StringFrom("https://picsum.photos/400/300?random=6"),
			Image:   null.StringFrom("https://picsum.photos/400/300?random=6"),
			Average: null.Float64From(4.6),
		},
		{
			Name:    null.StringFrom("Sala de Treinamento"),
			Type:    null.StringFrom("espaço"),
			Midia:   null.StringFrom("https://picsum.photos/400/300?random=7"),
			Image:   null.StringFrom("https://picsum.photos/400/300?random=7"),
			Average: null.Float64From(4.3),
		},
		{
			Name:    null.StringFrom("Tablet iPad Pro"),
			Type:    null.StringFrom("hardware"),
			Midia:   null.StringFrom("https://picsum.photos/400/300?random=8"),
			Image:   null.StringFrom("https://picsum.photos/400/300?random=8"),
	...
	activities := []*models.Activity{
		{
			...
			Image:       null.StringFrom("https://picsum.photos/600/400?random=11"),
		},
		{
			...
			Image:       null.StringFrom("https://picsum.photos/600/400?random=12"),
		},
		{
			...
			Image:       null.StringFrom("https://picsum.photos/600/400?random=13"),
		},
		{
		...
		},
		{
			...
			Type:        null.StringFrom("meeting"),
			Image:       null.StringFrom("https://picsum.photos/600/400?random=17"),
		},
		{
			...
			Image:       null.StringFrom("https://picsum.photos/600/400?random=18"),
		},
		{
			...
			Image:       null.StringFrom("https://picsum.photos/600/400?random=19"),
		},
		{
			...
			Image:       null.StringFrom("https://picsum.photos/600/400?random=20"),
		},
	}
